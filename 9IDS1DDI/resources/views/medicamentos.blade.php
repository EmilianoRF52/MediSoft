                ...
                <table id="table-data" class="table table-bordered">
                    ...
                    <tbody style=" background-color:rgb(255,255,255)" >
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('nuevo.medicamento',['id' => $medicamento['id']])}}" class="btn btn-success btn-sm rounded-8">
                            ...
                            <td>
                                <a>
                                <form action="{{route('eliminar.medicamento',['id' => $medicamento['id']])}}" method="POST" >
                                    @csrf
                                    @method('DELETE')
