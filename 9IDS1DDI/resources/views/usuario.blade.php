...
<div class="container mt-5 mx-3 my-3"> <!-- Agregamos las clases "mx-3" y "my-3" para agregar margen horizontal y vertical -->
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <form action="{{ route('usuario.guardar')}}" method="POST" class="shadow p-3 mb-5 bg-white rounded" style="animation: fadeInUp;">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control input-animation" id="name" name="name" value="{{$usuario->name}}" required>
                    </div>
                </div>
                @if ($usuario->id==0)
                    <div class="form-group row">
                        <label for="codigo" class="col-sm-3 col-form-label">Contraseña:</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control input-animation" id="password" name="password" required>
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="email" class="form-control input-animation" id="email" name="email" value="{{$usuario->email}}" required>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="nombre" class="col-sm-3 col-form-label">Rol:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control input-animation" id="rol" name="rol" value="{{$usuario->rol}}" required>
                    </div>
                </div>
